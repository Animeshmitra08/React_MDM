export interface MaterialTransactionsTypes {
  id: string;
  trN_ID: string;
  reQ_CODE: string; //reference num
  ...
  uom: string;  //base unit of measues
  ...
  model: string;
  parT_NUMBER: string;
  lonG_TEXT: string; // mat description
  ...
  assignmenT_GROUP: string; // account assignment group
  ...
  attribute_Data: string; //attribute
  materialTypeName: string;
  materialGroupName: string;
  materialSubGroupName: string;
  uomName: string;
  sapMaterialGroup: string; //el mat group
