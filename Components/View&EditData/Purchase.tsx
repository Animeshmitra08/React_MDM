    ...
    <Card style={[styles.card, { backgroundColor: colors.onPrimary }]}>
      ...
      <Card.Content>
        <View style={styles.row}>
          ...
          <Field label="Inhouse Production Time" value={data.inhousE_PROD_TIME} />
          <Field label="Planned Delivery Time(day's)" value={data.planneD_DELIVERY_TIME} />
          <Field label="GR Processing Time(day's)" value={data.gR_PROCESSING_TIME} />
          <Field label="Scheduling Margin Key" value={data.schedulinG_MARGIN_KEY} />
          <Field label="Period Indicator" value={data.perioD_INDICATOR_SHELF_LIFE} />
          <Field label="Planing Strategy Group" value={data.plaN_STRATEGY_GROUP} />
          <Field label="Dependent Requirements" value={data.dependenT_REQUIREMENTS} />
          <Field label="Production Scheduler" value={data.productioN_SCHEDULER} />
          <Field label="Forecast Model" value={data.foreCast_Model} />
          <Field label="Safety Stock" value={data.safetY_STOCK} />
          <Field label="Minimum Safety Stock" value={data.minimuM_SAFETY_STOCK} />
          <Field label="Maximum Safety Stock" value={data.maximuM_SAFETY_STOCK} />
          <Field label="Reorder Point" value={data.rE_ORDER_POINT} />
          <Field label="Production Storage Location" value={data.production_STLO} />
